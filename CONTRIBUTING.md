...
Welcome to `ecoflux` contributor's guide.
...
If you experience bugs or general issues with `ecoflux`, please have a look
...
You can help improve `ecoflux` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`ecoflux` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `ecoflux`'s files. While this mechanism can
...
```
conda create -n ecoflux python=3 six virtualenv pytest pytest-cov
conda activate ecoflux
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/ecoflux.git
   cd ecoflux
   ```
...
5. Install [pre-commit]:
   ...
   `ecoflux` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/ecoflux
[issue tracker]: https://github.com/<USERNAME>/ecoflux/issues
